...
import { AuthLoadingCardSkeleton } from '@/components/ui/skeleton'

// Este é o componente que contém useSearchParams
export default function ResetPasswordForm() {
    ...
    if (isCheckingSession) {
        return <AuthLoadingCardSkeleton caption="Verificando link" />
    }
